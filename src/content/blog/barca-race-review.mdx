...
import race from "./BMTL0213.jpeg"

 <figure className='my-5'>
 <Image src={race} alt="Halfway through the race." />
  <figcaption class="text-xs grey text-center">Half way through the race. Feeling good!</figcaption>
</figure> 
