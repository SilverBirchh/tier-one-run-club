...
If anyone is interested in organizing these events with me, enter your email below and lets connect!

import Contact from '../../components/contact.astro';
import {Input} from '../../components/ui/input.tsx';

<Contact client:idle post="Why We Run" title="Submit Form" containerClass="flex gap-5" buttonText="Connect" >
